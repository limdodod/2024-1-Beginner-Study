...
- 답: 
 1. 두 브랜치를 공통 부모로 하는 새로운 commit 'E'를 만듦 (A,B,C의 커밋이 그대로 main 브핸치로 병합)
 
 2. 하나의 커밋으로 main 브랜치로 병합
...
- 답: 
  1. 현재 작업중인 브랜치: develop 브랜치
  2. docs 유형, 내용: readme 추가
...
- 답: revert 선택. reset은 commit을 삭제하므로 위험하다.